...
static const char help_string[] = 
    ...
    "\n"
    "   need_datasync (for flushing download data)\n"
    "        Flushes write data on writes to local files during object download\n"
    "        (call fdatasync). There are cases where caching of write data causes\n"
    "        memory usage to rise, but this option avoids it.\n"
    "\n"
