...
void show_help (void)
{
  ...
  printf(
    ...
    "\n"
    "   prefetch (default=\"0\" bytes)\n"
    "        Amount of additional data to download in background to speed up\n"
    "        delayed readings.\n"
    "\n"
    ...
    "\n"
    "   nopagesmerge\n"
    "        Disable pages merge when downloading parts of objects. Instead of\n"
    "        downloading the whole object, only what is needed is dowloaded.\n"
    "\n"
    "FUSE/mount Options:\n"
    "\n"
