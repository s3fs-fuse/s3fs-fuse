...
if [ "${CONTAINER_FULLNAME}" = "ubuntu:21.10" ]; then
    ...
    INSTALL_PACKAGES="autoconf autotools-dev default-jdk fuse libfuse-dev libcurl4-openssl-dev libxml2-dev locales-all media-types mime-support libtool pkg-config libssl-dev attr wget python3-pip"
    INSTALL_CPPCHECK_OPTIONS=""
    ...
    INSTALL_PACKAGES="autoconf autotools-dev default-jdk fuse libfuse-dev libcurl4-openssl-dev libxml2-dev locales-all media-types mime-support libtool pkg-config libssl-dev attr wget python2 procps python3-pip"
    INSTALL_CPPCHECK_OPTIONS=""
