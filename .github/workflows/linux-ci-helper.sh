...
if [ "${CONTAINER_FULLNAME}" = "ubuntu:21.10" ]; then
    ...
    INSTALL_PACKAGES="autoconf autotools-dev fuse libfuse-dev libcurl4-openssl-dev libxml2-dev locales-all mime-support libtool pkg-config libssl-dev attr curl python3-pip"
    ...
    INSTALL_PACKAGES="autoconf autotools-dev fuse libfuse-dev libcurl4-openssl-dev libxml2-dev locales-all mime-support libtool pkg-config libssl-dev attr curl procps python3-pip"
    INSTALL_CPPCHECK_OPTIONS=""
    ...
    INSTALL_PACKAGES="curl-devel fuse fuse-devel gcc libstdc++-devel gcc-c++ glibc-langpack-en libxml2-devel mailcap git automake make openssl-devel attr diffutils curl python3"
    ...
    INSTALL_PACKAGES="curl-devel fuse fuse-devel gcc libstdc++-devel gcc-c++ glibc-langpack-en libxml2-devel mailcap git automake make openssl-devel attr curl python3 epel-release"
    ...
    INSTALL_PACKAGES="curl-devel fuse fuse-devel gcc libstdc++-devel gcc-c++ glibc-langpack-en libxml2-devel mailcap git automake make openssl-devel curl attr diffutils procps python3-pip"
    INSTALL_CPPCHECK_OPTIONS=""
    ...
    INSTALL_PACKAGES="automake curl-devel fuse fuse-devel gcc-c++ libxml2-devel make openssl-devel python3-pip curl attr"
    INSTALL_CPPCHECK_OPTIONS=""
